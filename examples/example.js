...
const validationService = ValidationService.init(
	{ number1: 5, string1: 'str1', object1: { val1: 1, innerObj: { val2: 2 } }, array1: ['a', 3, new Date()], someDate1: new Date(), undef: undefined, nullValue: null, nanValue: NaN, func: Function.get() },
...
const result =
	validationService
		.add('number1').should.be.in.rangeOf(10, 100).and.have.type('Number')
